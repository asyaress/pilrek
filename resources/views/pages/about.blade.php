                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-xl-6 mil-mb-80">
                            <div class="mil-image-frame mil-up">
                                <img src="{{ asset('template/img/inner-pages/1.png') }}" alt="image" class="mil-scale-img" data-value-1="1" data-value-2="1.2">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 mil-mb-60">
                                <div class="mil-icon-box">
                                    <img src="{{ asset('template/img/inner-pages/icons/1.svg') }}" alt="icon" class="mil-mb-30 mil-up">
                            ...
                            <div class="col-xl-4 mil-mb-60">
                                <div class="mil-icon-box">
                                    <img src="{{ asset('template/img/inner-pages/icons/2.svg') }}" alt="icon" class="mil-mb-30 mil-up">
                            ...
                            <div class="col-xl-4 mil-mb-60">
                                <div class="mil-icon-box">
                                    <img src="{{ asset('template/img/inner-pages/icons/3.svg') }}" alt="icon" class="mil-mb-30 mil-up">
            ...
            <div class="mil-features mil-p-160-80">
                <div class="container">
                    <div class="row flex-sm-row-reverse justify-content-between align-items-center">
                        ...
                        <div class="col-xl-5 mil-mb-80">
                            <div class="mil-image-frame mil-up">
                                <img src="{{ asset('template/img/inner-pages/2.png') }}" alt="image" class="mil-scale-img" data-value-1="1" data-value-2="1.2">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mil-out-frame mil-visible mil-image mil-p-160-130">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-sm-6">
                                <div class="mil-team-card mil-mb-30 mil-up">
                                    <div class="mil-portrait mil-mb-30">
                                        <img src="{{ asset('template/img/inner-pages/team/1.png') }}" alt="portrait">
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-sm-6">
                                <div class="mil-team-card mil-mb-30 mil-up">
                                    <div class="mil-portrait mil-mb-30">
                                        <img src="{{ asset('template/img/inner-pages/team/2.png') }}" alt="portrait">
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-sm-6">
                                <div class="mil-team-card mil-mb-30 mil-up">
                                    <div class="mil-portrait mil-mb-30">
                                        <img src="{{ asset('template/img/inner-pages/team/3.png') }}" alt="portrait">
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-sm-6">
                                <div class="mil-team-card mil-mb-30 mil-up">
                                    <div class="mil-portrait mil-mb-30">
                                        <img src="{{ asset('template/img/inner-pages/team/4.png') }}" alt="portrait">
                                    </div>
